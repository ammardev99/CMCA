...
final estimateOption = [
  ...
  Estimate(id: 3,title: "Finishing Cost", icon: EstimateIcons.none , color: const Color.fromARGB(255, 32, 154, 140), route:   EstimateForm.finishingEstimate),
  Estimate(id: 4,title: "Roof Cost", icon: EstimateIcons.none, color: const Color.fromARGB(255, 197, 197, 197), route:   EstimateForm.roofEstimate),
